...
export default function Hero() {
  ...
  return (
    <>
      ...
      {/* ─── DESKTOP HERO ─── */}
      <section className="relative hidden min-h-screen overflow-hidden bg-ink font-sans md:block">
        <div className="absolute inset-0">
          <Image
        ...
        <div className="pointer-events-none absolute inset-[22px] z-[3] border border-[rgba(207,168,90,0.42)]" />
        <div className="pointer-events-none absolute left-[34px] top-1/2 z-[3] -translate-y-1/2 rotate-180 text-[11px] tracking-[0.34em] uppercase text-gold-deep [writing-mode:vertical-rl]">
          Est. Atlanta · Virtual Nationwide
        </div>

        <div className="relative z-[2] flex min-h-screen flex-col">
          <header className="flex items-center justify-between gap-4 border-b border-[rgba(230,221,209,0.14)] px-[clamp(40px,6vw,92px)] py-6.5">
            <Image
              src="/images/nina-ross-logo-cream.png"
              alt="Nina Ross Functional Medicine, Atlanta"
              width={220}
            ...
            <div className="flex items-center gap-7.5">
              ...
              <span className="h-4.5 w-px bg-[rgba(230,221,209,0.22)]" />
              <Link
                href="/start"
          ...
          <div className="flex flex-1 items-center px-[clamp(40px,6vw,92px)] py-20">
