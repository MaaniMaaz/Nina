                ...
                {tab === 1 && (
                  <div className="relative rounded-xl border border-ink/10 border-l-[3px] border-l-gold-deep bg-cream px-[19px] py-5 md:rounded-[14px] md:p-7">
                    ...
                    <div className="mt-3.5 flex items-center gap-2.5 md:mt-5 md:gap-3">
                      ...
                      <div>
                        <div className="font-hand text-[23px] leading-[0.9] text-terracotta md:text-[26px]">Dr. Nina Ross</div>
                        <div className="mt-0.75 text-[8px] tracking-[0.1em] uppercase text-muted md:text-[9px]">ND · Ph.D</div>
                      </div>
                    </div>
                  </div>
                )}
                  ...
                  <div>
                    <div className="flex flex-col gap-2.5 md:hidden">
                      {story.actions.map((a) => (
                        <div key={a} className="flex items-start gap-[11px]">
                          ...
                          <span className="flex-1 text-[13.5px] leading-[1.5] text-[#5a4d43]">{a}</span>
                        </div>
                      ))}
                    </div>
                    <div className="mt-[18px] rounded-[14px] bg-olive px-[18px] pb-3.5 pt-[18px] md:mt-0 md:hidden">
                      ...
                      {story.markers.map((mk) => (
                        <div key={mk.label} className="mb-4">
                          <div className="flex items-baseline justify-between">
                            <span className="text-[12.5px] font-semibold text-cream-deep">{mk.label}</span>
                            <span className="font-display text-[21px] font-semibold leading-none text-[#9fb07a]">{mk.to}</span>
                          </div>
                          <div
            ...
            {PATIENT_CASES.map((c, i) => (
              ...
              >
                <span
                  ...
                  style={{
                    borderColor: i === storyIndex ? "#E9B45A" : "rgba(246,238,225,0.25)",
                    boxShadow: i === storyIndex ? "0 0 0 3px rgba(233,180,90,0.25)" : undefined,
                  }}
                >
                ...
                <span
                  className={`text-[8.5px] font-semibold md:text-[10px] ${
                    i === storyIndex ? "text-cream-deep" : "text-[#9aa585]"
                  }`}
                >
                  {c.first}
                </span>
