...
export default function ConditionExplorer({
  ...
  const active = conditions.find((c) => c.key === openKey) ?? null;
      ...
      <div className="mx-auto max-w-[1100px]">
        ...
        <div className="mt-8 grid grid-cols-2 gap-3 md:mt-11 md:grid-cols-3 md:gap-4">
          {conditions.map((c) => (
            ...
            >
              <span className="font-display text-[17px] text-ink md:text-xl">{c.label}</span>
